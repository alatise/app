...
import Payment from '@/assets/images/iconsvg/payment.svg';
    ...
    return (
        <SafeAreaView style={{ flex: 1 }} >
            <View className="flex-1 bg-white  px-4 pt-6">
                ...
                <ScrollView>
                    <MainHeader left={<Back onPress={() => router.back()} width={35} height={35} />} header={"Checkout"} right={<View />}
                    />
                    ...
                    <View className='flex-row items-center justify-between mt-6'>
                        <View className='flex-row items-center gap-3'>
                            <Delivery className='' />
                            <View>
                                <Text className='font-montserrat-Medium text-xl'>Delivery address</Text>
                                <Text className='font-montserrat-Regular text-sm'>123 Main Street, Anytown, USA 12345</Text>
                            </View>
                        </View>
                    ...
                    <View className='flex-row items-center justify-between mt-6 border-t-[0.5px] border-[#D9D9D9] pt-4'>
                        <View className='flex-row items-center gap-3'>
                            ...
                            <View>
                                ...
                                <Text className='font-montserrat-Regular text-sm'>XXXX XXXX XXXX 3456</Text>
                            </View>
                        </View>
                        <Arrow width={20} height={20} className='' />
                    </View>
                    ...
                    <View className='mt-6 border-t-[0.5px] border-[#D9D9D9] pt-4'>
                        ...
                        <TextInput numberOfLines={5} placeholder='Write Here' className='border-[0.3px] flex-row justify-start font-montserrat-Regular px-3 h-20 border-[#D9D9D9] mt-2 rounded-[8px]' />
                    </View>

                    <View className='mt-28'>

                        <View className='flex-row font-montserrat-Regular items-center justify-between '>
                ...
                <View className="flex-row items-center gap-3 border-[#D9D9D9] border-t py-4">
                    <Button onPress={() => { router.push('/(products)/deliveryAddress') }} children="Submit order" className="bg-black rounded-[8px] px-4 py-4  w-full"
