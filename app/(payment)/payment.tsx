    ...
    return (
        <SafeAreaView style={{ flex: 1 }} >
            <View className="flex-1 bg-white  px-4 pt-6">
                ...
                <ScrollView>
                    <MainHeader left={<Back onPress={() => router.back()} width={35} height={35} />} header={"Payment"} right={<View />}
                    />
                    ...
                    <View className='bg-[#F6F6F6]   flex-row items-center justify-between p-4 rounded-[8px] mt-4'>
                        <View className='flex-row items-center gap-3'>
                            ...
                            <Text className='font-montserrat-Medium text-sm '>Cash on Delivery(Cash/UPI)</Text>
                        </View>
                    ...
                    <View className='bg-[#F6F6F6] p-4 rounded-[8px] mt-4'>
                        <View className='  flex-row items-center justify-between border-b-[0.5px] border-[#D9D9D9] pb-4'>
                            <View className='flex-row items-center gap-3'>
                                ...
                                <Text className='font-montserrat-Medium text-sm '>Google Pay/Phone Pay/BHIM UPI</Text>
                            </View>
                        ...
                        <Text className='text-sm font-montserrat-Medium pt-4'>Link via UPI</Text>
                        <TextInput placeholder='Enter your UPI ID' className='bg-white border-[0.5px] px-4 font-montserrat-Regular border-[#ccc] rounded-[8px] mt-2' />

                        <Button onPress={() => { }} children="Continue" className="bg-black rounded-[8px] px-4 py-4 mt-3 w-full"
                            textClassName='text-white font-montserrat-Medium text-base' />

                        <View className='flex-row items-center gap-2 mt-4'>
                            <Ups />
                            <Text className='font-montserrat-Regular text-[13px] w-[85%]'>Your UPI ID Will be encrypted and is
                                100% safe with us.</Text>
                        </View>
                    </View>
                    ...
                    <View className='bg-[#F6F6F6] p-4 rounded-[8px] mt-4'>
                        <View className='  flex-row items-center justify-between border-b-[0.5px] border-[#D9D9D9] pb-4'>
                            <View className='flex-row items-center gap-3'>
                                ...
                                <Text className='font-montserrat-Medium text-sm '>Payments/Wallet</Text>
                            </View>
                        ...
                        <Text className='text-sm font-montserrat-Medium pt-4'>Link Your Wallet</Text>
                        <TextInput placeholder='+91' className='bg-white border-[0.5px] px-4 font-montserrat-Regular border-[#ccc] rounded-[8px] mt-2' />
                    ...
                    <View className='bg-[#F6F6F6]   flex-row items-center justify-between p-4 rounded-[8px] my-4'>
                        <View className='flex-row items-center gap-3'>
                            ...
                            <Text className='font-montserrat-Medium text-sm '>Netbanking</Text>
                        </View>
                ...
                <View className="flex-row items-center gap-3 border-[#D9D9D9] border-t py-4">
                    <Button onPress={() => { router.push('/(payment)/addCard') }} children="Continue" className="bg-black rounded-[8px] px-4 py-4  w-full"
                        textClassName='text-white font-montserrat-Medium text-base' />
                </View>
            </View>
        </SafeAreaView >
