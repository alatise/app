    ...
    <View className={` rounded-lg shadow-md p-4 py-6 mt-4 mr-4 ${className}`}>
      <View className="flex-row items-center justify-between mb-4">
        <View className="flex-row items-center gap-3">
          ...
          <Text className="text-white font-montserrat-Regular text-xs">
            CREDIT CARD
          </Text>
        </View>
        <Visa />
      ...
      <Text className="text-white font-montserrat-Regular text-lg tracking-[4px] pt-2">
        **** **** **** 4532
      </Text>
      ...
      <View className="flex-row items-center justify-between mt-4">
        ...
        <View className="flex-row items-center gap-8">
          <View>
            <Text className="text-[#c5c0c0] font-montserrat-Regular text-xs">
              EXP
            </Text>
